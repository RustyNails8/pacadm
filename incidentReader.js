...
class IncidentReader {
    constructor() {
        this.filePath = path.join(resourcesPath, 'INM.csv');
        this.data = [];
        this.headers = [];
        this.filters = {};
    }
    ...
    setupTable() {
        ...
        const requiredHeaders = ['Id', 'DisplayLabel', 'Priority', 'Status', 'RegisteredForActualService.DisplayLabel', 'SLT.TargetDate'];
    ...
    setupFilters() {
        ...
        const filterableColumns = ['Priority', 'Status'];
...
const incidentReader = new IncidentReader();
document.addEventListener('DOMContentLoaded', () => incidentReader.loadData());