...
class LandscapeReader {
    constructor() {
        this.filePath = path.join(resourcesPath, 'SID.List.csv');
        this.data = [];
        this.headers = [];
        this.filters = {};
    }
    ...
    setupTable() {
        ...
        const requiredHeaders = [
            ...
            'SLA',
            'Active',
            'Basis Landscape Owner 1',
            'Basis Landscape Owner 2',
            'Application Owner 1'
        ];
    ...
    setupFilters() {
        ...
        const filterableColumns = ['Level', 'Component', 'Operations Mode', 'SLA', 'Active'];
...
const landscapeReader = new LandscapeReader();
document.addEventListener('DOMContentLoaded', () => landscapeReader.loadData());